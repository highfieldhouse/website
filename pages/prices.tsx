...
export default function Page() {
  return (
    <>
      ...
      <main>
        <h2>Room rates 2021: bed &amp; breakfast</h2>
        <div className="md:flex">
          <div className="flex-1 mr-16">
            <ul className="prices">
              <li><span>£70</span> <span>Single Room per night</span></li>
              <li><span>£85/90</span> <span>Double room per night</span></li>
              <li><span>£100</span> <span>SuperKing/Twin room per night</span></li>
              <li><span>£110</span> <span>Family Room, 2 adults, 1 child (5-15 years)</span></li>
            </ul>
          </div>
          <div className="flex-1 max-w-xs">
            ...
            <p><strong>Away on business?</strong> Please call to discuss prices and options. If it's just a bed you're after, packed lunch and evening meal, or anything in between we'll have something to suit. Short and long stays welcome.</p>
