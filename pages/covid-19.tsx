...
export default function Page() {
  return (
    <>
      <Head>
        <title>COVID-19: Highfield House</title>
      </Head>
      ...
      <main>
        ...
        <ul className="list">
          ...
          <li>Equipping bedrooms with sanitizing spray, cloth and hand gels.</li>
          <li>Laundry is bagged up at the end of each stay and left sealed for 3-4 days before washing on high temperature.</li>
          <li>Reducing number of guests in dining room to 8 to allow for social distancing. At busy times we have 2 separate sittings and offer a takeaway option. Outside seating is available.</li>
        </ul>
        ...
        <p>We hope to keep everyone healthy with these steps. Please stay safe, and we hope you enjoy your stay!</p>
